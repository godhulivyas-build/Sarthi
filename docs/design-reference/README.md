...
**Usage:** Implement in React using these as **visual and UX reference only** — not pixel-perfect HTML ports. Production CSS variables live in [`/index.css`](/index.css).
